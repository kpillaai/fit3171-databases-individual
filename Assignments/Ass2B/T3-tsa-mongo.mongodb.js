...
// ENSURE that your query is formatted and has a semicolon
// (;) at the end of this answer
db.townsandresorts.find({"avg_temperature.summer":{$gt:25}, "resorts.company_name":"Tropical Dream"}, {"_id":0, "name":1});
...
// ENSURE that your query is formatted and has a semicolon
// (;) at the end of this answer
db.townsandresorts.updateMany({"resorts.company_name":"Tropical Dream"}, {$set:{"resorts.$.company_name":"Tropical Heaven"}});
db.townsandresorts.find({"resorts.company_name":"Tropical Heaven"});
...
db.townsandresorts.find({"resorts.name":"Amazing Resort"});
